...
const TaskList = () => {
    ...
    const openCreateModal = () => {
        setIsEditing(false);
        setTaskData({ title: '', description: '', priority: 'Medium', dueDate: '', assignee: '', status: 'Open', project: '' });
        setIsModalOpen(true);
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">All tasks across the workspace</p>
                </div>
            ...
            {loading ? (
                ...
                <div className="py-20 text-center text-gray-400 dark:text-gray-500">
                    ...
                    <p className="text-sm mt-1">{filter !== 'All' ? `No "${filter}" tasks` : 'Create a new task to get started'}</p>
                </div>
            ) : (
                            ...
                            <Link to={`/tasks/${task._id}`} className="block">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {task.assignee && (
                                            <div
                                                className="w-6 h-6 rounded-full bg-mint/20 text-mint flex items-center justify-center text-xs font-bold"
                ...
                <form onSubmit={handleSubmitTask} className="space-y-4 max-h-[70vh] overflow-y-auto p-1">
                    <div>
                        ...
                        <input
                            ...
                            disabled={isEditing && user?.role === 'developer'}
                        />
                    </div>
                    <div>
